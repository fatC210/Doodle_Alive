...
export const styles: StylePreset[] = [
  ...
  { id: 'pixar-3d', name: 'Pixar 3D', nameZh: '皮克斯3D', desc: 'Bright, soft, and full of life in a 3D animated world.', descZh: '明亮柔和，充满 3D 动画世界的生命力。', prompt: 'Pixar style 3D rendered character, soft lighting, expressive, friendly animated portrait', tone: 'pixar', image: '/images/styles/皮克斯3D.png' },
  { id: 'anime', name: 'Anime', nameZh: '日系动漫', desc: 'Detailed eyes with cel-shaded energy and clean line art.', descZh: '细致眼神、赛璐璐质感和清爽线条。', prompt: 'Japanese anime style, detailed eyes, cel-shaded, clean line art, elegant character portrait', tone: 'anime', image: '/images/styles/日系动漫.png' },
  { id: 'western-comic', name: 'Western Comic', nameZh: '美漫', desc: 'Bold heroic outlines, bright action and graphic shapes.', descZh: '大胆的英雄轮廓、明快动作感和图形化造型。', prompt: 'Western comic book style, bold outlines, halftone shading, heroic portrait illustration', tone: 'comic', image: '/images/styles/美漫.png' },
  { id: 'watercolor', name: 'Watercolor', nameZh: '水彩', desc: 'Soft edges, pastel tones and gentle handmade texture.', descZh: '柔软边缘、淡雅色调和温柔的手作质感。', prompt: 'Watercolor painting style, soft edges, pastel tones, handmade paper texture, gentle portrait', tone: 'watercolor', image: '/images/styles/水彩.png' },
  ...
  { id: 'chibi-kawaii', name: 'Chibi Kawaii', nameZh: 'Q版可爱', desc: 'Big-head cute, tiny body and playful toy-like proportions.', descZh: '大头萌感、小小身体和玩具般的可爱比例。', prompt: 'Chibi kawaii style, super-deformed, big head cute, adorable warm illustration', tone: 'chibi', image: '/images/styles/Q版可爱.png' },
];
